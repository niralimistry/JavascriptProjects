var country_arr = ["Afghanistan", "Albania", "Algeria", "American Samoa", "Angola", "Anguilla", "Antartica", "Antigua and Barbuda",
    "Argentina", "Armenia", "Aruba", "Ashmore and Cartier Island", "Australia", "Austria", "Azerbaijan", "Bahamas", "Bahrain",
    "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "Bolivia", "Bosnia and Herzegovina",
    "Botswana", "Brazil", "British Virgin Islands", "Brunei", "Bulgaria", "Burkina Faso", "Burma", "Burundi", "Cambodia", "Cameroon",
    ...
    "Costa Rica", "Cote d'Ivoire", "Croatia", "Cuba", "Cyprus", "Czeck Republic", "Denmark", "Djibouti", "Dominica", "Dominican Republic",
    ...
    "Macedonia, Former Yugoslav Republic of", "Madagascar", "Malawi", "Malaysia", "Maldives", "Mali", "Malta", "Man, Isle of",
    "Marshall Islands", "Martinique", "Mauritania", "Mauritius", "Mayotte", "Mexico", "Micronesia, Federated States of", "Midway Islands",
    "Moldova", "Monaco", "Mongolia", "Montserrat", "Morocco", "Mozambique", "Namibia", "Nauru", "Nepal", "Netherlands", "Netherlands Antilles",
    "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "Niue", "Norfolk Island", "Northern Mariana Islands", "Norway", "Oman",
    "Pakistan", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Pitcaim Islands", "Poland", "Portugal", "Puerto Rico",
    "Qatar", "Reunion", "Romainia", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", "Saint Pierre and Miquelon",
    "Saint Vincent and the Grenadines", "Samoa", "San Marino", "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles",
    "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Solomon Islands", "Somalia", "South Africa", "South Georgia and South Sandwich Islands",
    "Spain", "Spratly Islands", "Sri Lanka", "Sudan", "Suriname", "Svalbard", "Swaziland", "Sweden", "Switzerland", "Syria", "Taiwan", "Tajikistan",
    "Tanzania", "Thailand", "Tobago", "Toga", "Tokelau", "Tonga", "Trinidad", "Tunisia", "Turkey", "Turkmenistan", "Tuvalu", "Uganda",
    "Ukraine", "United Arab Emirates", "United Kingdom", "Uruguay", "USA", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Virgin Islands",
    "Wales", "Wallis and Futuna", "West Bank", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zimbabwe"];
var s_a = [];
s_a[0] = "";
...
var address1Text = document.getElementById("address1Text");
var address1 = document.getElementById("address1");
var address2Text = document.getElementById("address2Text");
var companyNameText = document.getElementById("companyNameText");
var companyName = document.getElementById("companyName");
var address2 = document.getElementById("address2");
var postalCodeText = document.getElementById("postalCodeText");
...
function edit() {
    firstName.value = fN.innerHTML;
    lastName.value = lN.innerHTML;
    email.value = emailText.innerHTML;
    companyName.value = companyNameText.innerHTML;
    state.value = stateText.innerHTML;
    country.value = countryText.innerHTML;
    address1.value = address1Text.innerHTML;
    address2.value = address2Text.innerHTML;
    postalCode.value = postalCodeText.innerHTML;
    phoneNumber.value = phoneNumberText.innerHTML;
}

function save(){
    fN.innerHTML = first.value;
    lN.innerHTML = lastName.value;
    emailText.innerHTML = email.value;
    companyNameText.innerHTML = companyName.value;
    stateText.innerHTML = state.value;
    countryText.innerHTML = country.value;
    address1Text.innerHTML = address1.value;
    address2Text.innerHTML = address2.value;
    postalCodeText.innerHTML = postalCode.value;
    phoneNumberText.innerHTML = phoneNumber.value;
}
